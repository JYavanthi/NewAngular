    ...
    public class PhonePeTestController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetTestOAuthToken()
        {
            try
            {
                ...
                string clientId = "TEST-M222NJL8ZHVEM_25041";
                string clientSecret = "NjIxZTdiZGYtMzlkOS00ZTkyLWFhNjItZTZhNTBjNTgyM2I0";
                ...
                using (var httpClient = new HttpClient())
                {
                    ...
                    // Log and return the raw response without any processing
